...
stp.hide_pages(["Student","jee","kcet","neet","Undergrad","Category-Selection","DSA","Engineering","Engg-courses","WEB_DEV","Engg-exams","gate","gre","books","neetpg","dashboard","AIML","APP_DEV"]);
